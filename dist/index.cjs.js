...
}, getButtonVariantProp("backgroundHover"), getButtonVariantProp("border"), getButtonVariantProp("backgroundActive"), getDisabledStyles, removePointerEvents, styledSystem.space);
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 52 52" }, props),
        React__default['default'].createElement("image", { width: "52", height: "52", href: "/images/rockswap/logo.svg" })));
};
...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/rockswap/rock_icon.svg" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/rockswap/logo.svg" })));
};
...
var Toggle = function (_a) {
    ...
    return (React__default['default'].createElement(StyledToggle, { checked: isChecked },
        ...
        React__default['default'].createElement(Handle, { checked: checked })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 52" }, props),
        React__default['default'].createElement("image", { width: "205", height: "52", href: isDark ? "/images/rockswap/logoTextDark.svg" : "/images/rockswap/logoTextLight.svg" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? React__default['default'].createElement(Icon$K, { width: "24px", color: "text" }) : React__default['default'].createElement(Icon$J, { width: "24px", color: "text" })),
        ...
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                React__default['default'].createElement(Flex, { alignItems: "center" },
                    React__default['default'].createElement(SunIcon, { color: isDark ? "text" : "text", width: "24px" }),
                    React__default['default'].createElement(Text, { color: "text", mx: "4px" }, "/"),
                    React__default['default'].createElement(MoonIcon, { color: isDark ? "text" : "text", width: "24px" }))),
            React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(LanguageIcon, { color: "text", width: "24px" }) },
...
var StyledPanel = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  position: fixed;\n  padding-top: 60px;\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 3px solid ", ";\n    width: ", ";\n  }\n"], ["\n  position: fixed;\n  padding-top: 60px;\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 3px solid ", ";\n    width: ", ";\n  }\n"])), function (_a) {
    ...
    var isPushed = _a.isPushed;
    return (isPushed ? "solid 3px #000" : 0);
}, function (_a) {
    var isPushed = _a.isPushed;
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React__default['default'].createElement(Icon$o, { color: "text", mr: "6px" }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fff", backgroundDisabled: "#c2c2c2", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#ececec", tertiary: "#ececec", text: "#000000", textDisabled: "#BDC2C4", textSubtle: "#0051fe", borderColor: "#000000", card: "#ececec", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#7645D9", background: "#fff", backgroundDisabled: "#c2c2c2", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#ececec", primaryDark: "#A86C47", tertiary: "#ececec", text: "#000000", textDisabled: "#BDC2C4", textSubtle: "#0051fe", borderColor: "#000000", card: "#ececec", gradients: {
...
var light$1 = (_a$2 = {},
    ...
    _a$2[DANGER] = {
        ...
        backgroundActive: lightColors.failure,
        backgroundHover: lightColors.failure,
        border: "3px solid " + lightColors.text,
        borderColorHover: "currentColor",
        boxShadow: "none",
        boxShadowActive: "none",
    ...
    _a$2[SUBTLE] = {
        ...
        backgroundHover: lightColors.textSubtle,
        border: "3px solid " + lightColors.text,
        borderColorHover: "currentColor",
        boxShadow: "none",
        boxShadowActive: "none",
